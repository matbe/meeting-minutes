...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            database::vocabulary_commands::get_vocabulary_sets,
            database::vocabulary_commands::get_vocabulary_set,
            database::vocabulary_commands::create_vocabulary_set,
            database::vocabulary_commands::update_vocabulary_set,
            database::vocabulary_commands::delete_vocabulary_set,
            database::vocabulary_commands::get_vocabulary_entries,
            database::vocabulary_commands::add_vocabulary_entry,
            database::vocabulary_commands::update_vocabulary_entry,
            database::vocabulary_commands::delete_vocabulary_entry,
            database::vocabulary_commands::toggle_vocabulary_entry,
            database::vocabulary_commands::get_active_vocabulary,
        ...
        .run(|_app_handle, event| {
            match &event {
                // When the main window is destroyed, also destroy the overlay popup
                tauri::RunEvent::WindowEvent { label, event: win_event, .. } => {
                    if label == "main" {
                        if let tauri::WindowEvent::Destroyed = win_event {
                            ...
                            if let Some(overlay) = _app_handle.webview_windows().get("teams-overlay") {
