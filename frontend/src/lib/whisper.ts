...
// Helper function to get model type (f16, q5_1, q5_0, q8_0, q4_0)
export function getModelType(modelName: string): 'f16' | 'q5_1' | 'q5_0' | 'q8_0' | 'q4_0' {
...
export function getModelTagline(modelName: string, speed: ProcessingSpeed, accuracy: ModelAccuracy): string {
  ...
  if (isQuantized) {
    ...
    } else if (quantType === 'q5_1') {
      featureText += ', balanced+';
